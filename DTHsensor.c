...
/******************************************************************************
 * Function:        void TransmitMeasure(void)
 *
 * PreCondition:    "measure" struct must be refreshed/initialized
 *
 * Input:           None
 *
 * Output:          None
 ...
 * Side Effects:    None
 *
 * Overview:        Converts measure structure in the hid structure defined in usb_descriptors.c
 *					and sends it only if the TxUsbStack is not busy
 *
 * Note:            
 *
 *****************************************************************************/
